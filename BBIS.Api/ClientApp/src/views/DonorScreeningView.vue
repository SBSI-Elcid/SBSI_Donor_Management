        ...
        <v-card>
            <v-card-actions>
                ...
                <div class="d-flex align-center mr-4">
                    ...
                    <span class="pl-3 mt-2"><strong class="black--text">{{ donorActivityType }}</strong></span>
                </div>
            </v-card-actions>
            <v-divider></v-divider>
...
<script lang="ts">
    ...
    export default class DonorScreeningView extends VueBase {
        ...
        protected get donorActivityType(): string {
            return this.donorModule.getDonorActivityType ?? "Walk-In";
        }
