<template>
  <div>
      <v-form class="form-container" ref="form" v-model="formValid" lazy-validation>
          <!-- FIRST SECTION: NAME -->
          <v-row class= "m-2"><h4>Personal Information</h4><v-divider></v-divider></v-row>
          <v-row>
          ...
          <v-row><h4>Current Home Address</h4><v-divider></v-divider></v-row>
          <v-row>
              <v-col cols="12" lg="3" md="3" sm="12" class="py-0">
          ...
          <v-row><h4>Other Information</h4><v-divider></v-divider></v-row>
          <v-row>
          ...
          <v-row><h4>Contact Information</h4><v-divider></v-divider></v-row>
          <v-row>
              <v-col cols="12" lg="3" md="3" sm="12" class="py-0">
      ...
      <v-btn color="default" large class="mt-2 mr-2" @click="checkForNext">Next <v-icon size="25" color="primary" right>mdi-chevron-right</v-icon></v-btn>
          ...
          <div class="section-outer-container text-right pt-3 pb-2">
            <v-btn v-if="!inReviewPage" color="primary" large class="mr-2" @click="checkForSubmit">Submit <v-icon size="25" left>mdi-content-save</v-icon> {{ submitLabel }}</v-btn>
          </div>
