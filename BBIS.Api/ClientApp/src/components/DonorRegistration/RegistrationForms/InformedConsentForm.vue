  ...
  <div>
    <v-form class="form-container" ref="form" v-model="formValid" lazy-validation>
      <table style="width:100%">
        <tr>
          <td style="width: 65%;">
            ...
            <label class="subtitle-1 pa-2">
              <div class="pr-2 pl-2 text-center">
                <p>I certify that I am the person referred to in all entries which wre read and well understood by me. I am made aware of the advantages of voluntary blood donation and that it has to be done out of my free will,
      ...
      <div class="section-outer-container text-right pt-3 pb-2">
        ...
        <v-btn v-if="!inReviewPage" color="primary" large class="mr-2" @click="checkForSubmit"><v-icon size="25" left>mdi-content-save</v-icon> {{ submitLabel }}</v-btn>
      </div>
    </v-form>
  </div>
</template>
