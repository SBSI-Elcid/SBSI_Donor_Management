...
export default class CreatePatient extends VueBase {
  @Prop({ required: true })
  ...
  protected async save(): Promise<void> {
    ...
    try {
      let reult = await this.patientService.create(this.model);
      this.notify_success('Patient successfully created.');
      this.onClose(true);
    } catch (error: any) {
