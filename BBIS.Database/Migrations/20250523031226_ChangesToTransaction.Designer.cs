...
namespace BBIS.Database.Migrations
{
    ...
    [Migration("20250523031226_ChangesToTransaction")]
    partial class ChangesToTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBIS.Domain.Models.DonorBloodBagIssuance", b =>
                {
                    ...
                    b.ToTable("DonorBloodBagIssuance");
                });
            ...
            modelBuilder.Entity("BBIS.Domain.Models.MedicalQuestionnaire", b =>
                {
                    ...
                    b.Property<string>("QuestionBisayaText")
                        .HasColumnType("varchar(500)");
            ...
            modelBuilder.Entity("BBIS.Domain.Models.DonorBloodBagIssuance", b =>
                {
                    b.HasOne("BBIS.Domain.Models.DonorTransaction", "DonorTransaction")
                        .WithOne("DonorBloodBagIssuance")
                        .HasForeignKey("BBIS.Domain.Models.DonorBloodBagIssuance", "DonorTransactionId")
            ...
            modelBuilder.Entity("BBIS.Domain.Models.DonorTransaction", b =>
                {
                    ...
                    b.Navigation("DonorBloodBagIssuance");
