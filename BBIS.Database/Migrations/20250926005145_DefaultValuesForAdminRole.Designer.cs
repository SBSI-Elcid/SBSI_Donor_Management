...
namespace BBIS.Database.Migrations
{
    ...
    [Migration("20250926005145_DefaultValuesForAdminRole")]
    partial class DefaultValuesForAdminRole
    {
            ...
            modelBuilder.Entity("BBIS.Domain.Models.UserRoleScreeningAccess", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("f2541bd0-f3d1-46e5-845f-c135a2efe4a4"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(2948),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForVitalSigns",
                            ScreeningTabName = "DonorVitalSigns"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("7d0629f9-0741-4f17-9d5a-c728bf016467"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(2976),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForDonorInformation",
                            ScreeningTabName = "DonorInformation"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("ff6699d3-d066-4f77-8fef-3ea8a8af94fe"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3009),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForInitialScreening",
                            ScreeningTabName = "InitialScreening"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("30b9b419-ceb8-4732-aed7-b02c5e24f149"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3016),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForPhysicalExamination",
                            ScreeningTabName = "PhysicalExam"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("cb2e08a7-68ba-46a7-bf82-4a513b46e407"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3023),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForCounseling",
                            ScreeningTabName = "Counseling"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("ddbea6bb-e8ea-4c3a-95ed-f45ccd11023c"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3029),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForConsent",
                            ScreeningTabName = "ConsentForm"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("dc94927e-0424-49c8-a684-bd31c8271718"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3036),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForMethodBloodCollection",
                            ScreeningTabName = "MethodBloodCollection"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("80ad4294-fc61-436b-b507-d1d97b93ebe6"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3043),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForBloodIssuance",
                            ScreeningTabName = "IssuanceOfBloodBag"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("4cf3ce3e-6f24-480c-97a1-539a32b45076"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3049),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForBloodCollection",
                            ScreeningTabName = "BloodCollection"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("21c00507-acc4-44a5-b7e2-79e13e270de7"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3056),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "ForPostDonationCare",
                            ScreeningTabName = "PostDonationCare"
                        },
                        new
                        {
                            UserRoleScreeningAccessId = new Guid("e52c36fc-d441-43b0-866e-f996340b2220"),
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 43, 313, DateTimeKind.Local).AddTicks(3069),
                            RoleId = new Guid("489abc53-af8a-4914-bd21-7d99c26e2e33"),
                            ScreeningStatus = "Deferred",
                            ScreeningTabName = "Deferred"
                        });
                });
