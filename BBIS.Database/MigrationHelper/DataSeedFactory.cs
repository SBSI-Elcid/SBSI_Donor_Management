    ...
    public static class DataSeedFactory
    {
        ...
        private static void AddModules(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Module>().HasData(
                ...
                new Module { OrderNo = 4, ModuleId = Guid.Parse("bc8d57ab-af77-4ec3-a348-5d040802f6e3"), Menu = "Test Orders", Icon = "mdi-hand-coin-outline", Link = "/orders/donors", IsActive = false, IsParentMenu = false },    
                new Module { OrderNo = 5, ModuleId = Guid.Parse("a0fe13b2-3b07-468f-91e8-b74b26b64f12"), Menu = "Requisitions", Icon = "mdi-form-select", Link = "/requisitions/availability", IsActive = false, IsParentMenu = false },    
                new Module { OrderNo = 6, ModuleId = Guid.Parse("7402be5a-bc2f-47b9-a389-b2c72c7173ba"), Menu = "Patients", Icon = "mdi-account-injury", Link = "/patients", IsActive = false, IsParentMenu = false },    
                new Module { OrderNo = 7, ModuleId = Guid.Parse("be14af28-ad5b-46b3-80a0-9952a98b876e"), Menu = "Inventory", Icon = "mdi-table", Link = "/inventory", IsActive = false, IsParentMenu = false },    
