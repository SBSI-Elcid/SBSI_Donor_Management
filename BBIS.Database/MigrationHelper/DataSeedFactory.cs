    ...
    public static class DataSeedFactory
    {
        ...
        private static void AddModules(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Module>().HasData(
                ...
                new Module { OrderNo = 3, ModuleId = Guid.Parse("bc8d57ab-af77-4ec3-a348-5d040802f6e3"), Menu = "Test Orders", Icon = "mdi-hand-coin-outline", Link = "/orders/donors", IsActive = true, IsParentMenu = false },    
                new Module { OrderNo = 4, ModuleId = Guid.Parse("a0fe13b2-3b07-468f-91e8-b74b26b64f12"), Menu = "Requisitions", Icon = "mdi-form-select", Link = "/requisitions/availability", IsActive = true, IsParentMenu = false },    
                new Module { OrderNo = 5, ModuleId = Guid.Parse("7402be5a-bc2f-47b9-a389-b2c72c7173ba"), Menu = "Patients", Icon = "mdi-account-injury", Link = "/patients", IsActive = true, IsParentMenu = false },    
                new Module { OrderNo = 6, ModuleId = Guid.Parse("be14af28-ad5b-46b3-80a0-9952a98b876e"), Menu = "Inventory", Icon = "mdi-table", Link = "/inventory", IsActive = true, IsParentMenu = false },    
                new Module { OrderNo = 7, ModuleId = Guid.Parse("bec0b869-882f-4661-8bc1-856f6accca16"), Menu = "Reports", Icon = "mdi-chart-bar-stacked", Link = "/reports", IsActive = true, IsParentMenu = false },    
                new Module { OrderNo = 8, ModuleId = Guid.Parse("f0fa95f2-2288-434f-8df6-71f00e9be302"), Menu = "Setting", Icon = "mdi-cog", Link = "/setting", IsActive = true, IsParentMenu = true },    
                new Module { OrderNo = 9, ModuleId = Guid.Parse("53223248-2221-4d48-a551-8477a33e96c4"), Menu = "Users", Icon = "mdi-account-cog-outline", Link = "/users", IsActive = true, IsParentMenu = false, ParentModuleId = Guid.Parse("f0fa95f2-2288-434f-8df6-71f00e9be302") },    
                new Module { OrderNo = 10, ModuleId = Guid.Parse("22a8eb15-168c-470a-a680-71e85b8514c6"), Menu = "App Setting", Icon = "mdi-cogs", Link = "/app-settings/unit-of-measurement", IsActive = true, IsParentMenu = false, ParentModuleId = Guid.Parse("f0fa95f2-2288-434f-8df6-71f00e9be302") },   
                new Module { OrderNo = 11, ModuleId = Guid.Parse("68b94e71-abf0-4989-aa29-9ec6d6419a9c"), Menu = "Signatories", Icon = "mdi-draw", Link = "/signatories", IsActive = true, IsParentMenu = false, ParentModuleId = Guid.Parse("f0fa95f2-2288-434f-8df6-71f00e9be302") }    
            );
        }
    }
}
